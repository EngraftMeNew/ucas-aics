...
def vgg19():
    ...
    for i, layer_name in enumerate(layers):
        if layer_name.startswith('conv'):
            # TODO: 在时序容器中传入卷积运算
            if layer_name in ['conv1_1','conv1_2']:
                out_channels = 64
            elif layer_name in ['conv2_1','conv2_2']:
                out_channels = 128
            elif layer_name in ['conv3_1','conv3_2',  'conv3_3', 'conv3_4']:
                out_channels = 256
            elif layer_name in ['conv4_1', 'conv4_2', 'conv4_3', 'conv4_4']:
                out_channels = 512
            elif layer_name in ['conv5_1', 'conv5_2', 'conv5_3', 'conv5_4']:
                out_channels = 512
            else:
